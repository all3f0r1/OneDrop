...
impl MilkContext {
    ...
    fn init_defaults(ctx: &mut HashMapContext) {
        ...
        ctx.set_value("bass_att".to_string(), Value::Float(0.0))
            .ok();
        ...
        ctx.set_value("wave_mystery".to_string(), Value::Float(0.0))
            .ok();
        ctx.set_value("wave_mode".to_string(), Value::Float(0.0))
            .ok();
        ...
        ctx.set_value("echo_zoom".to_string(), Value::Float(1.0))
            .ok();
        ctx.set_value("echo_alpha".to_string(), Value::Float(0.0))
            .ok();
